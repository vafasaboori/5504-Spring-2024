...
# autop4lot is a generic function to visualize various data object
...
# The classical method captured the sudden fall in 2009 better as error
...
# Overlayed plot
autoplot(elecequip, series="Data") +
  autolayer(trendcycle(fit), series="Trend") + # trendcycle()  extract trend component
  autolayer(seasadj(fit), series="Seasonally Adjusted") + # seasadj() compute seasonally adjusted (deseasonalized) time series
  xlab("Year") + ylab("New orders index") +
  ggtitle("Electrical equipment manufacturing (Euro area)")  +
