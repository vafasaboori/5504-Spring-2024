...
# Section 4 In Class Practice (Q15-9 House Prices) ----
...
# part a
plot(house)
# scatterplot matrix, showing relationships between pairs of variables in a data frame.
...
# Section 6 In Class Practice (Q15-25 Auto-Resale) ----
...
# Section 7 Prediction and Confidence Interval NFL ----
# Read Excel file in R
library(readxl)
...
# Section 8 Categorical Independent Variables ----
# Read Excel file in R
library(readxl)
...
# Section 9 In Class Practice (Q15-37 Fridge) ----
# Read Excel file in R
library(readxl)
...
simmons %>% ggplot(aes(Spending, Coupon)) +
  geom_point(size = 3, alpha = 0.3) + # scatter plot
...
# Section 12 In class Practice 15-46 Direct Deposit ----
...
# Iterate over different values of x
...
# odds of direct deposit goes up by (1.2463 times) with each $100 increment balance
